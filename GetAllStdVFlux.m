...
function AllStdVFlux=GetAllStdVFlux(reMin,reMax,Nre,Widths,fNbefaft,AllExtrusion,x,y,u_filtered,v_filtered)
   ...
   if lengthAE>0
     for i=1:lengthAE
               ...
               for f=1:2*fNbefaft+1
                   for r=1:Nre
                       ...
                       if ExtFrame-fNbefaft+f-1>=1  &&  ExtFrame-fNbefaft+f-1<=Totframes
                          ...
                          [StdVelocityFlux(f,r)]=GetStdVelocityFlux(Widths,Rext,Xext,Yext,PIVx,PIVy,PIVu,PIVv);
                       end
               ...
               %AllAvgVFlux
               %AverageVelocityFlux
               AllStdVFlux=[AllStdVFlux;StdVelocityFlux];
