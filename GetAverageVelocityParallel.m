...
function [AverageVelocityFlux]=GetAverageVelocityParallel(Widths,Rext,Xext,Yext,PIVx,PIVy,PIVu,PIVv)
...
%                     hold on
                    ...
                    Number=Number+1;
                    sumFlux=sumFlux+sqrt(norm(v_vect).^2-(dot(re_vect,v_vect)/norm(re_vect)).^2);  
