...
function AllAvgVFlux=GetAllAvgVParallel(reMin,reMax,Nre,Widths,fNbefaft,AllExtrusion,x,y,u_filtered,v_filtered)
               ...
               for f=1:2*fNbefaft+1
                   for r=1:Nre
                       ...
                       if ExtFrame-fNbefaft+f-1>=1  &&  ExtFrame-fNbefaft+f-1<=Totframes
                          ...
                          [AverageVelocityFlux(f,r)]=GetAverageVelocityParallel(Widths,Rext,Xext,Yext,PIVx,PIVy,PIVu,PIVv);
                       end
